#ifndef _INCLUDED_LEXICAL_ANALYZER_
#define _INCLUDED_LEXICAL_ANALYZER_
...
/*
 ...
 ソースコードをトークンに分解する
*/
typedef struct _LEXICAL_ANALYZER
{
...
/*
 ...
 analyzer	: ソースコードをトークンに分解するためのデータ
*/
EXTERN void ReleaseLexicalAnalyzer(LEXICAL_ANALYZER* analyzer);
...
#endif	// #ifndef _INCLUDED_LEXICAL_ANALYZER_
